...
//                state.postValue(ViewState.failure(ERROR_CONNECTION))
//            }
//
...
//                          state: MutableLiveData<ViewState<String>>,
//                          enterpriseList: MutableLiveData<List<Enterprise>>) {
//
...
//            }
//
//            override fun onResponse(call: Call<ListEnterprises>,
//                                    response: Response<ListEnterprises>) {
//
